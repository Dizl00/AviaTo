...
<head>
    ...
    <script type="text/javascript" src="js/min/wickedpicker.min.js"></script>  
    ...
    <link rel="stylesheet" type="text/css" href="css/lib/wickedpicker.min.css">
        ...
        <header id="header-page">
            <div class="header-page__inner">
                <div class="container">
                    <!-- LOGO -->
                    <div class="logo">
                        <a href="index.php?page=index"><img src="images/logo.png" alt=""></a>
                    </div>
                    <!-- END / LOGO -->
                    ...
                    <nav class="navigation awe-navigation" data-responsive="1200">
                        <ul class="menu-list">
                            <li class="menu-item-has-children">
                                <a href="index.php?page=index">Главная</a>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="index.php?page=flight">Авиабилеты</a>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="contact.html">Contact</a>
                            </li>
                            <li>
                                <a class="head-link"  href="index.php?page=yourcart"><i class="awe-icon awe-icon-cart"></i></a>
                            </li>
                            <li>
                                <a class="head-link"  href="index.php?page=login"><i class="awe-icon awe-icon-user"></i></a>
                            </li>
                        </ul>
